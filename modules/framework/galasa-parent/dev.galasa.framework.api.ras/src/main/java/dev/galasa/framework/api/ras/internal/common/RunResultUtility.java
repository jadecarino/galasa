...
public class RunResultUtility {
	...
	public @NotNull RasRunResult toRunResult(@NotNull IRunResult runResult, boolean isMethodDetailsExcluded)
		...
		RasRunResult newRunResult = new RasRunResult(runId, artifacts, structure, baseWebUiUrl, baseServletUrl);

		return newRunResult;

	}

	private List<RasArtifact> getArtifacts(Path path) {
